...
class SubtitleTranslatorApp:
    def __init__(self, root):
        ...
        lang_menu = tk.OptionMenu(self.load_controls_frame, self.target_lang, "English", "French", "German", "Arabic")
    ...
    def hide_translation_box(self, event=None):
        if self.translation_box:
            self.translation_box.destroy()
            self.translation_box = None
    ...
    def translate_word(self, word):
        ...
        try:
            prompt = f"Translate the Spanish word '{word}' to {self.target_lang.get()}. Provide only the translated word or a short phrase."
