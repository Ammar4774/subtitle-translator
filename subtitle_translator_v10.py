...
class SubtitleTranslatorApp:
    ...
    def update_subtitles(self, event):
        ...
        if not subtitle_line and self.translation_box.winfo_ismapped():
    ...
    def show_translation_box(self, translation, label_widget):
        ...
        y = label_widget.winfo_rooty() - self.video_frame.winfo_rooty() - self.translation_box.winfo_reqheight()
    ...
    def hide_translation_box(self):
        ...
        self.translation_box.config(bg="black") # Set background to black
